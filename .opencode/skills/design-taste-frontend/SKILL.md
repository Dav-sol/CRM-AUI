...
**Baseline:** `4 / 5 / 7` (CRM SaaS: professional, restrained motion, dense data-first). Use these unless the design read overrides them. Do not ask the user to edit this file - overrides happen conversationally.
